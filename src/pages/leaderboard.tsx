      ...
      <div className="relative p-8">
        <div className="max-w-5xl mx-auto space-y-12">
          ...
          >
            ...
            <div className="absolute -inset-1 bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 rounded-lg blur opacity-25 group-hover:opacity-75 transition duration-1000 group-hover:duration-200 animate-gradient-xy"></div>
                  ...
                  <AnimatePresence mode="popLayout">
                    {data.map((item, index) => (
                      <motion.tr
                        ...
                        exit={{ opacity: 0, x: 20 }}
                        className="group/row hover:bg-white/10 transition-colors duration-300 border-white/20"
                      >
                        <TableCell className="relative w-20">
                          <div className="relative w-14 h-14">
                            <motion.div 
                              ...
                              } flex items-center justify-center font-black text-2xl shadow-lg group-hover/row:scale-110 transition-transform duration-300`}
                            >
                        ...
                        <TableCell>
                          <motion.div layout className="flex items-center gap-4">
                            <div>
                              <div className="text-xl font-bold tracking-wide group-hover/row:text-transparent group-hover/row:bg-clip-text group-hover/row:bg-gradient-to-r group-hover/row:from-blue-400 group-hover/row:to-purple-400 transition-all duration-300">
                                {item.name}
                              </div>
                            </div>
                          </motion.div>
